...
std::string Downloader::GetDefaultModelDir() {
...
void Downloader::DownloadModelAsync(
    ...
    std::thread([this, targetFileName, onProgress, onComplete]() {
        ...
        size_t chunkSize = 15 * 1024 * 1024;  // 每块 15 MB 模拟下载
