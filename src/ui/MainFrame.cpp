...
void MainFrame::InitUI() {
    ...
    wxBitmapBundle minBundle = IconManager::GetIconBundle(
        SVG::MINIMIZE, wxSize(14, 14), palette.textSecondary);
    wxBitmapBundle maxBundle = IconManager::GetIconBundle(
        SVG::MAXIMIZE, wxSize(14, 14), palette.textSecondary);
    wxBitmapBundle closeBundle = IconManager::GetIconBundle(
        SVG::CLOSE, wxSize(14, 14), palette.textSecondary);
    ...
    m_closeBtn = new wxBitmapButton(m_topHeaderPanel, wxID_ANY, closeBundle,
            wxDefaultPosition, wxSize(30, 30), wxBORDER_NONE);
