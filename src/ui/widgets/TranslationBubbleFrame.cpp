...
namespace LinguaAlpaca::UI {
	...
	void TranslationBubbleFrame::InitUI() {
		...
		wxBitmapBundle retryBundle = IconManager::GetIconBundle(SVG::REPLACE, wxSize(15, 15), palette.textSecondary);
		m_retryBtn = new wxBitmapButton(m_headerPanel, wxID_ANY, retryBundle, wxDefaultPosition, dip(30, 30), wxBORDER_NONE);
		m_retryBtn->SetBackgroundColour(palette.sidebarBg);
		m_retryBtn->SetToolTip(L"重新翻译 (再次请求模型)");

		wxBitmapBundle copyBundle = IconManager::GetIconBundle(SVG::COPY, wxSize(15, 15), palette.textSecondary);
		m_copyBtn = new wxBitmapButton(m_headerPanel, wxID_ANY, copyBundle, wxDefaultPosition, dip(30, 30), wxBORDER_NONE);
		...
		m_closeBtn = new wxBitmapButton(m_headerPanel, wxID_ANY, closeBundle, wxDefaultPosition, dip(30, 30), wxBORDER_NONE);
	...
	void TranslationBubbleFrame::UpdateTheme() {
		...
		if (m_pinBtn) {
			...
			wxBitmapBundle pinBundle = IconManager::GetIconBundle(SVG::PIN, wxSize(15, 15), pinColor);
	...
	void TranslationBubbleFrame::OnTogglePin(wxCommandEvent& WXUNUSED(event)) {
		...
		wxBitmapBundle pinBundle = IconManager::GetIconBundle(SVG::PIN, wxSize(15, 15), iconColor);
		m_pinBtn->SetBitmap(pinBundle);
